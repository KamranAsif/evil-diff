...
describe('retainFn', () => {
  ...
  describe('should retain inputs', () => {
    ...
    describe('and should be called twice for new objs', () => {
      ...
      const primitives = [
        {'type' : 'number', value : 2}, {'type' : 'string', value : '3'},
        {'type' : 'boolean', value : true}, {'type' : 'null', value : {}},
